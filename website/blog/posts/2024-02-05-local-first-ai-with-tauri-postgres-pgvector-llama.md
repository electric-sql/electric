...
<video class="w-full" controls poster="/videos/blog/local-first-ai-with-tauri-postgres-pgvector-llama/intro.jpg">
...
- the generation is performed by a LLM hosted by a company like <span class="no-wrap">[OpenAI](https://platform.openai.com/docs/sync/duction) or [Google](https://ai.google.dev/docs)</span>
