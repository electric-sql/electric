...
Today, we're open-sourcing [Durable Streams](/products/durable-streams): a persistent stream primitive and HTTP protocol for reliable, resumable, real-time data streaming into client applications.
