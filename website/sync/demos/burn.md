...
Burn is a multi-user, multi-agent demo app built on [TanStack&nbsp;DB](/sync/tanstack-db) and [Phoenix.Sync](https://hexdocs.pm/phoenix_sync).
...
[<img src="/img/integrations/tanstack.svg" alt="TanStack icon" width="48" /> TanStack&nbsp;DB](/sync/tanstack-db)
