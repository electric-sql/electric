      ...
      '/about': [
        {
          ...
          items: [
            ...
            },
            {
              text: 'Legal',
              items: [
                { text: 'Terms of service', link: '/about/legal/terms' },
                { text: 'Privacy Policy', link: '/about/legal/privacy' },
                { text: 'Cookie Policy', link: '/about/legal/cookies' },
                { text: 'DPA', link: '/about/legal/dpa' },
              ],
              collapsed: false,
            },
