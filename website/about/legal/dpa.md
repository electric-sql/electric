...
description: >-
  Data Processing Addendum for Electric DB Inc. describing how we
  process personal data on behalf of our customers.
outline: deep
---
...
This DPA amends and forms part of the written agreement between Customer and Electric DB Inc. (further "Electric" or the "Company") (collectively, "the parties") pursuant to the [Terms of Service](/about/legal/terms) or other agreement for the provision of services to the Customer (the "Agreement"). This DPA prevails over any conflicting term of the Agreement but does not otherwise modify the Agreement.
...
**"Standard Contractual Clauses"** means (i) Module 2 of the Standard Contractual Clauses for the transfer of Personal Data to third countries pursuant to Regulation (EU) 2016/679 of the European Parliament and the Council approved by European Commission Implementing Decision (EU) 2021/914 of 4 June 2021, as currently set out at [https://eur-lex.europa.eu/eli/dec_impl/2021/914/oj](https://eur-lex.europa.eu/eli/dec_impl/2021/914/oj) (the "EU SCCs"), and (ii) where the UK GDPR applies, the EU SCCs as supplemented by the International Data Transfer Addendum to the EU Commission Standard Contractual Clauses issued by the Commissioner under S119A(1) Data Protection Act 2018 (the "UK SCCs").
...
Customer agrees that Company may use the third-party suppliers listed on the Subprocessor List available at [/about/legal/subprocessors](/about/legal/subprocessors) to Process Personal Data on its behalf for the provision of the services under the Agreement (each a "Subprocessor").

Prior to authorizing any new Subprocessor to access Personal Data, Company will update the Subprocessor List. Updates to the Subprocessor List will be provided by email to account owners and by updating the Subprocessor List published as provided in the Subprocessing section above. If Customer objects to the appointment of such Subprocessor within ten (10) days, it may terminate the portion of the services that cannot be provided without such Subprocessor on written notice to Company that includes Customer's legitimate and documented grounds for non-approval.

Company will ensure that any Subprocessors to which it transfers Personal Data enter into written agreements with Company requiring that the Subprocessor abide by terms substantially similar to those contained in this DPA.
...
Unless prohibited by Data Protection Law, Company must inform Customer without undue delay if Company:
...
Company will make available to Customer at Customer's request information which is necessary to demonstrate compliance with this DPA and allow for any audits, including inspections, conducted by Customer or another auditor, as requested by Customer.
...
Any individuals whose personal data the customer submits to or processes through the Services, including:

- End users of the customer's applications and services
- The customer's employees, contractors, and authorized users
- The customer's own customers and business contacts

**Categories of personal data transferred:**

Any personal data Customer provides for processing in connection with the Services, including:

- Identifiers (e.g., names, email addresses, usernames, user IDs, device identifiers, IP addresses)
- Application data (e.g., user-generated content, messages, events, documents, preferences, settings)
- Usage and behavioral data (e.g., activity logs, interaction data, session data, timestamps)
- Location data (e.g., if included by the customer in their application data)
- Any other personal data the customer includes in Customer Content synced via Postgres shapes, written to durable streams, or processed through any other protocols supported by the Services

**Sensitive data transferred (if applicable):**

The Services are not designed for processing sensitive or special category data. The customer is responsible for determining whether Customer Content includes sensitive data and for complying with any additional requirements under applicable Data Protection Law. Electric does not require or request sensitive data to provide the Services.
...
Electric processes personal data within Customer Content solely to provide the Electric Services, including:

- Ingesting data written to durable streams
- Storing and retaining data according to TTL and retention configurations set by the customer
- Replicating data across infrastructure for durability and availability
- Caching data at edge locations via CDN for read delivery
- Delivering data to the customer's end-user clients via HTTP streaming and related protocols
- Processing Postgres replication streams (shapes)
- Chunking, formatting, and transforming data for transport
- Metering usage for billing purposes
- Providing support services requested by the customer
