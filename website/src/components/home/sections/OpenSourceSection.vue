  ...
  <EaSection :dark="true">
    ...
    <div class="repo-grid">
      ...
      >
        ...
        <div class="repo-stats">
          <span class="repo-stat"
            >☆ {{ repos['electric-sql/electric'].stars }}</span
          >
          <span
            v-if="repos['electric-sql/electric'].downloads"
            class="repo-stat"
            >↓ {{ repos['electric-sql/electric'].downloads }}</span
          >
        </div>
      </a>
      <a
      ...
      >
        ...
        <div class="repo-stats">
          <span class="repo-stat"
            >☆ {{ repos['electric-sql/pglite'].stars }}</span
          >
          <span v-if="repos['electric-sql/pglite'].downloads" class="repo-stat"
            >↓ {{ repos['electric-sql/pglite'].downloads }}</span
          >
        </div>
      </a>
      <a
      ...
      >
        <div class="repo-name">
          <svg
            width="32"
            height="32"
            viewBox="22 18 225 225"
            fill="currentColor"
          >
            <path
              d="M229.101 77.1836L229.687 77.2017C230.456 78.0158 231.487 80.7413 231.997 81.8956C235.665 90.1859 238.499 98.5994 241.177 107.26C237.993 106.072 233.613 104.891 230.278 103.895L207.693 97.313C204.43 96.1888 199.954 95.0195 196.539 93.9767C193.089 88.3281 189.93 84.497 185.582 79.4601C200.083 78.602 214.59 77.8431 229.101 77.1836Z"
            />
            <path
              d="M28.4828 110.905C29.7146 111.853 30.938 112.893 32.1406 113.885C42.736 122.621 53.4575 131.261 63.9368 140.135C64.524 143.862 65.3217 147.552 66.3251 151.187C66.6729 152.407 68.3398 156.581 67.9555 157.386L67.3848 157.255C54.4714 152.434 39.7928 147.647 27.2133 142.454C27.2224 141.511 27.1901 140.464 27.144 139.517C26.6705 129.826 27.4288 120.527 28.4828 110.905Z"
            />
            <path
              d="M28.8228 153.74L72.88 166.496C74.8605 169.758 76.701 172.502 79.1639 175.445C80.5995 177.16 82.1523 178.833 83.5063 180.589C82.7868 180.594 82.0426 180.634 81.3218 180.662C71.864 181.41 61.9464 181.606 52.4401 182.236C48.379 182.505 44.2082 182.537 40.1521 182.905C35.9368 174.586 31.3231 162.845 28.8228 153.74Z"
            />
            <path
              d="M201.076 103.614C213.455 107.528 225.772 112.256 237.999 116.621C239.604 117.194 241.22 117.818 242.798 118.46C243.132 129.474 243.238 138.122 241.598 149.184L236.655 145.27L236.059 144.781L215.294 128.392C212.735 126.362 207.662 122.606 205.538 120.576C204.395 113.268 203.189 110.381 201.076 103.614Z"
            />
            <path
              d="M185.163 181.082C185.531 181.776 187.337 221.141 187.405 224.402C180.817 228.13 166.53 233.289 159.236 235.295L157.329 235.766C158.033 233.328 158.824 230.884 159.597 228.466C163.479 216.323 166.819 203.93 170.807 191.827C176.755 188.072 179.765 185.679 185.163 181.082Z"
            />
            <path
            ...
            />
            <path
              d="M72.7565 42.5505C73.2799 43.0843 77.5711 83.003 78.0378 87.0322C75.6078 89.7167 73.3938 93.4996 71.6524 96.698C70.7291 98.394 70.0222 100.124 68.9747 101.791C67.4096 98.8905 65.8876 95.9681 64.4097 93.0244C59.4486 83.3134 54.5736 73.5609 49.7847 63.7675C50.9882 62.2736 52.8039 60.4293 54.1526 59.0081C59.8061 52.9551 66.0355 47.4446 72.7565 42.5505Z"
            />
            <path
              d="M201.044 159.209C202.242 160.118 219.178 194.544 220.215 197.094C215.774 202.436 210.06 207.699 204.866 212.354C202.334 214.419 199.773 216.451 197.185 218.45C196.423 214.285 195.932 207.709 195.433 203.383L191.962 173.977C195.502 169.982 198.598 163.899 201.044 159.209Z"
            />
            <path
              d="M201.205 45.2847C201.798 45.4272 209.889 53.1361 210.874 54.1236C215.015 58.2769 219.449 62.9985 222.949 67.6822C219.037 67.9573 214.441 68.5464 210.488 68.9738L183.301 71.9978L177.249 72.6264C171.297 68.3561 167.982 67.1512 161.886 63.8393C166.512 61.9302 172.247 58.9392 176.87 56.7399L201.205 45.2847Z"
            />
            <path
              d="M206.485 130.044C207.32 130.459 212.203 135.235 213.212 136.175C221.677 144.07 230.088 152.028 238.443 160.046C235.993 167.204 232.72 174.6 229.422 181.372L225.925 188.373C223.091 183.561 220.2 177.966 217.449 173.024C212.801 164.843 208.254 156.601 203.81 148.301C204.484 144.871 205.107 142.058 205.59 138.547C205.994 135.613 206.127 132.882 206.485 130.044Z"
            />
            <path
            ...
            />
            <path
              d="M165.155 27.0569C165.795 27.1969 168.941 28.4091 169.629 28.6956C177.044 31.7821 185.951 35.6252 192.873 39.6544C189.693 41.2082 185.555 43.6819 182.433 45.4347C174.957 49.6974 167.452 53.9101 159.919 58.0715C157.711 59.3047 155.487 60.5109 153.249 61.6898C147.32 60.0686 141.527 59.5076 135.456 58.8722C138.423 55.4811 142.217 51.6666 145.341 48.3324L165.155 27.0569Z"
            />
            <path
              d="M42.9158 72.6267C50.7773 85.8739 58.5357 99.18 66.1898 112.544C64.7432 119.508 64.0036 123.939 63.3685 130.956L58.2073 126.294C55.6936 123.825 52.7727 121.513 50.2065 119.117C43.5846 112.933 36.2476 106.943 29.7341 100.721C33.574 90.6783 37.9205 82.0796 42.9158 72.6267Z"
            />
            <path
              d="M90.6079 187.467C91.1401 187.346 93.8778 189.534 94.5631 190C98.3302 192.561 102.337 194.285 106.291 196.424C102.951 198.226 99.0158 200.075 95.5942 201.785L67.3695 215.715L64.3657 212.906C58.2147 207.334 51.1316 199.6 46.1392 192.861C47.9276 192.523 50.5896 192.268 52.4634 192.042L63.8638 190.672C72.6253 189.621 81.8686 188.326 90.6079 187.467Z"
            />
            <path
            ...
            />
            <path
              d="M160.728 197.487L160.974 197.514C161.066 198.048 147.55 234.351 146.2 238.157C135.635 238.784 128.252 238.617 117.516 237.101L115.405 236.791C118.515 233.213 121.558 229.246 124.557 225.545C131.023 217.533 137.543 209.566 144.115 201.645C150.565 200.384 154.358 199.449 160.728 197.487Z"
            />
          </svg>
          Durable Streams
        </div>
        ...
        <div class="repo-stats">
          <span class="repo-stat"
            >☆ {{ repos['durable-streams/durable-streams'].stars }}</span
          >
          <span
            v-if="repos['durable-streams/durable-streams'].downloads"
            class="repo-stat"
            >↓ {{ repos['durable-streams/durable-streams'].downloads }}</span
          >
        </div>
      </a>
      <a
      ...
      >
        ...
        <div class="repo-stats">
          ...
          <span v-if="repos['TanStack/db'].downloads" class="repo-stat"
            >↓ {{ repos['TanStack/db'].downloads }}</span
          >
        </div>
      </a>
    </div>
