<template>
  <div class="entity-overview">
    <svg viewBox="0 0 560 240" class="overview-svg">
      ...
      <text x="214" y="63" text-anchor="middle" class="box-sub">
        ctx + wake
      </text>

      <!-- Durable Stream -->
      <rect x="296" y="30" width="244" height="52" rx="5" class="inner-box" />
      <text x="418" y="46" text-anchor="middle" class="box-label">
        Durable Stream
      </text>
      <rect
        v-for="(_, i) in events"
      ...
      <text x="214" y="107" text-anchor="middle" class="box-label">
        Agent Loop
      </text>
      <text x="214" y="123" text-anchor="middle" class="box-sub">
        LLM ↔ tools
      </text>
      ...
      <text x="361" y="123" text-anchor="middle" class="box-sub">
        collections
      </text>
      ...
      <g v-for="(c, i) in coords" :key="'c' + i">
        ...
        <text :x="c.cx" y="172" text-anchor="middle" class="coord-label">
          {{ c.label }}
        </text>
        ...
        <rect
          ...
          class="child-box"
        />
        <text :x="c.cx" y="207" text-anchor="middle" class="child-label">
          {{ c.path }}
        </text>
        <text :x="c.cx" y="220" text-anchor="middle" class="child-sub">
          {{ c.id }}
        </text>
      </g>
    </svg>
