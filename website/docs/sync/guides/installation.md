...
You need to have a [Postgres](https://www.postgresql.org) database and to run the [Electric sync service](/sync/) in front of it.
...
See the [PostgreSQL Permissions guide](/docs/sync/guides/postgres-permissions) for detailed instructions on configuring database users with the necessary permissions for Electric.
