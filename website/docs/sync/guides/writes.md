...
Electric does [read-path sync](/sync). It syncs data out-of Postgres, into local apps and services.
...
Well, the [design philosophy](/blog/2024/07/17/electric-next) behind Electric is to be composable and [integrate with your existing stack](/blog/2024/11/21/local-first-with-your-existing-api). So, just as you can sync into [any client](/docs/sync/guides/client-development) you like, you can implement writes in any way you like, using a variety of different patterns.
...
> You don't need to engage with these complexities to [get started with Electric](/docs/sync/quickstart).
...
- [TanStack Query](/docs/sync/integrations/tanstack)
- [Valtio](https://valtio.dev)
- [Vue `vue-useoptimistic`](https://github.com/shoko31/vue-useoptimistic)

### Frameworks

- [LiveStore](/docs/sync/integrations/livestore)
- [TinyBase](https://tinybase.org)
- [tRPC](https://github.com/KyleAMathews/trpc-crdt)

See also the list of local-first projects on the [alternatives page](/docs/sync/reference/alternatives#local-first).
