...
This website contains the main documentation for [Postgres&nbsp;Sync](/sync).

Usage examples and recipes often use Postgres&nbsp;Sync together with [TanStack&nbsp;DB](/sync/tanstack-db). Guides like [Auth](/docs/sync/guides/auth) and [Security](/docs/sync/guides/security) are also generally relevant for [Durable&nbsp;Streams](/streams).

### Project websites

[Durable&nbsp;Streams](/streams), [TanStack&nbsp;DB](/sync/tanstack-db) and [PGlite](/sync/pglite) each have their own docs:
