...
Electric can be integrated with MobX by syncing data into a [Shape](/docs/sync/api/clients/typescript#shape) and then [making the shape observable](https://mobx.js.org/observable-state.html).
