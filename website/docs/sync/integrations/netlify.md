...
> The easiest way is to use the [Electric Cloud](/cloud/). Or see the [Deployment guide](/docs/sync/guides/deployment).

Copy the URL to your Electric instance and use it when [syncing data](/docs/sync/api/clients/typescript#shape) into your app. E.g.: by [setting an environment variable](https://docs.netlify.com/environment-variables/get-started/#site-environment-variables) and using it in your code:
...
See the [Client docs](/docs/sync/api/clients/typescript) for more information.
