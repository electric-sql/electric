...
Electric and Neon have also collaborated to develop [PGlite](/sync/pglite), which was started as a project by Neon's CTO, [Stas Kelvich](https://github.com/kelvich).
