...
You can use the Electric [Typescript client](/docs/sync/api/clients/typescript) in your Expo applications. This allows you to sync data from Electric into mobile apps.
