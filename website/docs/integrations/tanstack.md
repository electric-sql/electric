...
Electric have [partnered with TanStack](https://tanstack.com/blog/tanstack-db-0.1-the-embedded-client-database-for-tanstack-query) to build [TanStack&nbsp;DB](/primitives/tanstack-db), a reactive client store for building super fast apps on sync.
