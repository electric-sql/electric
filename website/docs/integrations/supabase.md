...
Electric and Supabase are also collaborating to develop [PGlite](/primitives/pglite), which Supabase sponsor, contribute to and have developed [database.build](https://database.build) on.
