...
2. **Durable Transport** &mdash; use [Durable&nbsp;Streams](/primitives/durable-streams) with the [Vercel AI SDK](https://sdk.vercel.ai)

## Durable Transport for AI

The Vercel AI SDK is a popular toolkit for building AI-powered applications. Electric's [Durable&nbsp;Streams](/primitives/durable-streams) provide a **Durable Transport** layer that makes AI token streams resilient to network interruptions.
