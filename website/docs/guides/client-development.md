...
The [Electric sync service](/primitives/postgres-sync) syncs data over an [HTTP API](/docs/api/http). The primary job of a client is to consume this API using HTTP requests.
