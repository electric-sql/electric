...
### ELECTRIC_SHAPE_DB_CACHE_SIZE_KB

<EnvVarConfig
    name="ELECTRIC_SHAPE_DB_CACHE_SIZE_KB"
    defaultValue="4096"
    example="8196">

The value of the [`cache_size` PRAGMA](https://sqlite.org/pragma.html#pragma_cache_size) set on every connection to the shape db. Higher values will result in more memory usage but improved performance.
