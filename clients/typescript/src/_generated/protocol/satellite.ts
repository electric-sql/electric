...
export interface SatRpcRequestOptions {
  $type: "Electric.Satellite.SatRpcRequestOptions";
...
export interface SatRpcRequest {
  ...
  method: string;
  requestId: number;
  options: SatRpcRequestOptions | undefined;
  message: Uint8Array;
}
...
function createBaseSatRpcRequestOptions(): SatRpcRequestOptions {
  return { $type: "Electric.Satellite.SatRpcRequestOptions", traceparent: undefined };
}

export const SatRpcRequestOptions = {
  $type: "Electric.Satellite.SatRpcRequestOptions" as const,

  encode(message: SatRpcRequestOptions, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SatRpcRequestOptions {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSatRpcRequestOptions();
  ...
  create<I extends Exact<DeepPartial<SatRpcRequestOptions>, I>>(base?: I): SatRpcRequestOptions {
    return SatRpcRequestOptions.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SatRpcRequestOptions>, I>>(object: I): SatRpcRequestOptions {
    const message = createBaseSatRpcRequestOptions();
...
messageTypeRegistry.set(SatRpcRequestOptions.$type, SatRpcRequestOptions);
...
export const SatRpcRequest = {
  ...
  encode(message: SatRpcRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.options !== undefined) {
      SatRpcRequestOptions.encode(message.options, writer.uint32(34).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.options = SatRpcRequestOptions.decode(reader, reader.uint32());
          continue;
        case 3:
          if (tag !== 26) {
            break;
  ...
  fromPartial<I extends Exact<DeepPartial<SatRpcRequest>, I>>(object: I): SatRpcRequest {
    ...
    message.options = (object.options !== undefined && object.options !== null)
      ? SatRpcRequestOptions.fromPartial(object.options)
      : undefined;
