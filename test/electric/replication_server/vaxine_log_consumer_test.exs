         ...
         {{[], [], [], [],
           [
             [
               ...
               | {1_657_818_413_774_141, "public:entries:f7a20872-67ec-4132-a417-e503446b9dba"}
             ]
           ],
           [
             [
               ...
               | {[],
                  [
                    <<161, 101, 148, 88, 58, 44, 232, 44, 61, 177, 85, 60, 244, 50, 76, 10, 205,
                      7, 91, 172>>
                  ]}
             ]
           ],
                      ...
                      [
                        ...
                        | {1_657_818_413_774_211,
                           <<131, 109, 0, 0, 0, 36, 102, 55, 97, 50, 48, 56, 55, 50, 45, 54, 55,
                             101, 99, 45, 52, 49, 51, 50, 45, 97, 52, 49, 55, 45, 101, 53, 48, 51,
                             52, 52, 54, 98, 57, 100, 98, 97>>}
                      ]
                    ], [], [], [], [], [], [], [],
                    [
                      [
          ...
          {[
             {{"deleted?", :antidote_crdt_flag_dw},
              {:ok,
               {[], [],
                [
                  <<161, 101, 148, 88, 58, 44, 232, 44, 61, 177, 85, 60, 244, 50, 76, 10, 205, 7,
                    91, 172>>
                ]}}}
           ], []},
          {[
              ...
              {:ok,
               {[
                  {{"content", :antidote_crdt_register_lww},
                   {:ok,
                    {1_657_818_413_774_204,
                     <<131, 109, 0, 0, 0, 14, 105, 108, 105, 107, 101, 116, 114, 97, 105, 110,
                       115, 49, 48, 48>>}}}
                ], []}}},
             {{"row", :antidote_crdt_map_rr},
              {:ok,
              ...
              {:ok,
               {[
                  {{"id", :antidote_crdt_register_lww},
                   {:ok,
                    {1_657_818_413_774_211,
                     <<131, 109, 0, 0, 0, 36, 102, 55, 97, 50, 48, 56, 55, 50, 45, 54, 55, 101,
                       99, 45, 52, 49, 51, 50, 45, 97, 52, 49, 55, 45, 101, 53, 48, 51, 52, 52,
                       54, 98, 57, 100, 98, 97>>}}}
                ], []}}}
           ], []},
          {[
             {{"schema", :antidote_crdt_register_lww}, {:ok, {1_657_818_413_774_299, "public"}}}
           ], []},
          {[
             {{"table", :antidote_crdt_register_lww}, {:ok, {1_657_818_413_774_431, "entries"}}}
           ], []}
        ]},
