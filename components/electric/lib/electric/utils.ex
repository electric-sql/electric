defmodule Electric.Utils do
  ...
  @doc """
  Convert a string representing a UUID into a raw binary.

  Code taken from Ecto: https://github.com/elixir-ecto/ecto/blob/v3.10.2/lib/ecto/uuid.ex#L88
  """
  @spec uuid_to_bin(binary) :: {:ok, binary} | :error
  def uuid_to_bin(
        <<a1, a2, a3, a4, a5, a6, a7, a8, ?-, b1, b2, b3, b4, ?-, c1, c2, c3, c4, ?-, d1, d2, d3,
          d4, ?-, e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11, e12>>
      ) do
