defmodule Electric.Satellite.Permissions do
  ...
  A `#{inspect(__MODULE__)}` struct is generated from a set of protobuf permissions definitions -- a lis
  t
  of `SatPerms.Grant` structs direct from the DDLX ingest, and a list of `SatPerms.Role` structs
