...
[
  ...
  defmodule Electric.Satellite.SatRpcRequest do
    @moduledoc false
    defstruct method: "", request_id: 0, message: "", options: nil
    ...
    (
      ...
      [
        ...
        defp encode_options(acc, msg) do
          try do
            if msg.options == nil do
              acc
            else
              [acc, "\"", Protox.Encode.encode_message(msg.options)]
            end
          rescue
            ArgumentError ->
              ...
              {4, _, bytes} ->
                ...
                {[
                   options:
                     Protox.MergeMessage.merge(
                       msg.options,
                       Electric.Satellite.SatRpcRequestOptions.decode!(delimited)
                     )
                 ], rest}
    ...
    (
      ...
      def defs() do
        %{
          ...
          4 => {:options, {:scalar, nil}, {:message, Electric.Satellite.SatRpcRequestOptions}}
        }
      end
      ...
      def defs_by_name() do
        %{
          ...
          options: {4, {:scalar, nil}, {:message, Electric.Satellite.SatRpcRequestOptions}},
      ...
      def fields_defs() do
        [
          ...
          %{
            ...
            name: :options,
            tag: 4,
            type: {:message, Electric.Satellite.SatRpcRequestOptions}
          }
        ]
      end
  ...
  defmodule Electric.Satellite.SatRpcRequestOptions do
    @moduledoc false
    defstruct traceparent: nil
    ...
    (
      ...
      [
        defp encode_traceparent(acc, msg) do
          try do
            case msg.traceparent do
              nil -> [acc]
              child_field_value -> [acc, "\n", Protox.Encode.encode_string(child_field_value)]
            end
          rescue
            ArgumentError ->
              reraise Protox.EncodingError.new(:traceparent, "invalid field value"),
                      __STACKTRACE__
          end
        end
      ]
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.SatRpcRequestOptions))
          end
        )
      )
          ...
          {field, rest} =
            case Protox.Decode.parse_key(bytes) do
              ...
              {1, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[traceparent: Protox.Decode.validate_string(delimited)], rest}
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.SatRpcRequestOptions,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
    ...
    (
      ...
      def defs() do
        %{1 => {:traceparent, {:oneof, :_traceparent}, :string}}
      end
      ...
      def defs_by_name() do
        %{traceparent: {1, {:oneof, :_traceparent}, :string}}
      end
    )
    ...
    (
      ...
      def fields_defs() do
        [
          %{
            __struct__: Protox.Field,
            json_name: "traceparent",
            kind: {:oneof, :_traceparent},
            label: :proto3_optional,
            name: :traceparent,
            tag: 1,
            type: :string
