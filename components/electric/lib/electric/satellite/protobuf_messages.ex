...
[
  ...
  defmodule Electric.Satellite.SatShapeDef.Select do
    @moduledoc false
    defstruct tablename: "", schemaname: nil
    ...
    (
      (
        ...
        @spec encode!(struct) :: iodata | no_return
        def encode!(msg) do
          [] |> encode_schemaname(msg) |> encode_tablename(msg)
        end
      )
    ...
    (
      ...
      def defs() do
        %{
          ...
          2 => {:schemaname, {:oneof, :_schemaname}, :string}
        }
      end
      ...
      def defs_by_name() do
        %{
          schemaname: {2, {:oneof, :_schemaname}, :string},
          ...
          {field, rest} =
            case Protox.Decode.parse_key(bytes) do
              ...
              {5, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[columns: msg.columns ++ [Protox.Decode.validate_string(delimited)]], rest}
