...
default_in_memory_wal_window = 256 * 1024 * 1024
...
wal_window_config =
  [
    ...
    {"ELECTRIC_IN_MEMORY_WAL_WINDOW", default_in_memory_wal_window}
  ]
      ...
      postgres_1: [
        ...
        wal_window:
          Enum.map(wal_window_config, fn
            ...
            {"ELECTRIC_IN_MEMORY_WAL_WINDOW", {:ok, size}} -> {:in_memory_size, size}
          end)
      ]
    ]
  end
