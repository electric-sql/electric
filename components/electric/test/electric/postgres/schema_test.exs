defmodule Electric.Postgres.SchemaTest do
  ...
  test "create table; alter .. set default" do
    ast1 = %Proto.Table{
      name: %Proto.RangeVar{name: "AiSq_XEbXrx"},
      columns: [
        %Proto.Column{
          name: "Rkr_eTvsYB",
    ...
    ast2 = %Proto.Table{
      name: %Proto.RangeVar{name: "ejbGPyO"},
      columns: [
        %Proto.Column{
          name: "RGkesnb",
                 ...
                 constraint:
                   {:foreign,
                    %Proto.Constraint.ForeignKey{
                      name: "b_a_id_fkey",
                      fk_cols: ["a_id"],
                      pk_table: %Proto.RangeVar{name: "a"},
                      pk_cols: ["a_fish"],
                      match_type: :SIMPLE,
                      on_delete: :NO_ACTION,
                      on_update: :NO_ACTION
                ...
                constraint:
                  {:foreign,
                   %Proto.Constraint.ForeignKey{
                     name: "c_b_a_id_fkey",
                     fk_cols: ["b_a_id"],
                     pk_table: %Proto.RangeVar{name: "b"},
                     pk_cols: ["a_id"]
                   }}
              }
            ]
                 ...
                 constraint:
                   {:foreign,
                    %Proto.Constraint.ForeignKey{
                      name: "b_a_id_fkey",
                      fk_cols: ["a_id"],
                      pk_table: %Proto.RangeVar{name: "c"},
                      pk_cols: ["a_id"],
                      match_type: :SIMPLE,
                      on_delete: :NO_ACTION,
                      on_update: :NO_ACTION
      ...
      sqls = [
        {"""
         ...
         Schema.order([
           %Proto.Index{
             name: "my_index",
             table: %Proto.RangeVar{name: "my_table"},
             columns: [
