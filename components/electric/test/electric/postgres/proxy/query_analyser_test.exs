  ...
  describe "analyse/2" do
    ...
    test "ELECTRIC...", cxt do
      assert [
               %QueryAnalysis{
                 action:
                   {:electric, %Electric.DDLX.Command{cmds: %Electric.DDLX.Command.Enable{}}},
                 table: {"public", "truths"},
                 electrified?: true,
                 tx?: true,
                 allowed?: true,
                 capture?: true,
                 ast: %Electric.DDLX.Command{cmds: %Electric.DDLX.Command.Enable{}},
      ...
      assert [
               %QueryAnalysis{
                 action: {:electric, %Electric.DDLX.Command{cmds: %{revokes: [_]}}},
                 table: {"public", "truths"},
                 electrified?: true,
                 tx?: true,
                 allowed?: true,
                 capture?: true,
                 ast: %Electric.DDLX.Command{},
                 sql:
    ...
    test "multitple ELECTRIC commands", cxt do
      ...
      assert [
               ...
               %QueryAnalysis{
                 action: {:electric, %Electric.DDLX.Command{}},
                 table: {"public", "truths"},
                 electrified?: true,
                 tx?: true,
                 allowed?: true,
