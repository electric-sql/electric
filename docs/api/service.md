...
import ElectricInMemoryWalWindow from './_ELECTRIC_IN_MEMORY_WAL_WINDOW.md'
...
### ELECTRIC_IN_MEMORY_WAL_WINDOW

<EnvVarConfig
    name="ELECTRIC_IN_MEMORY_WAL_WINDOW"
    defaultValue="256M"
    example="2g">
  <ElectricInMemoryWalWindow />
</EnvVarConfig>
