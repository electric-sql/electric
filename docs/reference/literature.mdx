...
The [ElectricSQL system](../index.mdx) builds on decades of research into local-first software and distributed database consistency, integrity and performance. In many cases, this research has been pioneered by [ElectricSQL's team and advisors](/about/team).
