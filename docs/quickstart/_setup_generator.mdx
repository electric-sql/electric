...
Change directory into `my-app` and start the backend services. This will use Docker Compose to run [Postgres](../usage/installation/postgres.mdx) and the [Electric sync service](../usage/installation/service.mdx):
...
Generate your [type-safe database client](../usage/data-access/client.mdx):
