...
:::warning
Insure mode is convienient to use in development and testing.  However, you must switch to [Secure mode](./secure.mdx) before moving into production.
:::
...
This is an optional setting that works the same in both insecure and secure auth modes. See the documentation page for the [Secure auth mode](./secure.mdx#auth_jwt_namespace) to learn more.
