...
You can now include this token in the [client instantiation code](../data-access/client.mdx) to have your client successfully authenticate with the server instance we configured above:
