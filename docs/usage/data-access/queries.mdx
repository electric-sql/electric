...
Once data has [synced into your app](./shapes.mdx), you can read it from the local database. You have a choice of using the [Prisma-inspired](https://www.prisma.io/docs/concepts/components/prisma-client) client API. Or you can just [drop down to raw SQL](#raw-sql).
...
Read data using the [`findUnique`](../../api/clients/typescript.mdx#findUnique), [`findFirst`](../../api/clients/typescript.mdx#findFirst) and [`findMany`](../../api/clients/typescript.mdx#findMany) functions.
...
Register live queries using the [`liveUnique`](../../api/clients/typescript.mdx#liveUnique), [`liveFirst`](../../api/clients/typescript.mdx#liveFirst) and [`liveMany`](../../api/clients/typescript.mdx#liveMany) functions.
...
If the higher-level client API doesn't support the SQL features that you need for your queries, you can drop down to raw SQL yourself using the [`raw`](../../api/clients/typescript.mdx#raw) and [`liveRaw`](../../api/clients/typescript.mdx#raw) functions.
