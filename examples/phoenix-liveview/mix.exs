defmodule Electric.PhoenixExample.MixProject do
  ...
  def application do
    [
      mod: {Electric.PhoenixExample.Application, []},
  ...
  defp deps do
    [
      ...
      {:bandit, "~> 1.5"},
      {:phoenix_sync, "~> 0.4.1"},
      {:electric_client, ">= 0.4.0", override: true}
    ]
  end
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind electric_phoenix_example", "esbuild electric_phoenix_example"],
      "assets.deploy": [
