...
import { Item, Player, Tournament } from '../../electric'
...
const TournamentWidget = ({
  ...
  const players = tournament.players
    ? [...tournament.players].sort(
        (a, b) => parseInt(a.updated_at) - parseInt(b.updated_at),
      )
    : []
  ...
  return (
    <div
      ...
      className={clsx(
        styles.tournament,
        isActive ? styles.tournamentActive : '',
      )}
