...
const { LightTheme: CustomLightNavigationTheme, DarkTheme: CustomDarkNavigationTheme } =
...
export { CustomLightTheme, CustomDarkTheme, CustomLightNavigationTheme, CustomDarkNavigationTheme };
