defmodule ApiWeb.Router do
  ...
  scope "/" do
    ...
    # this along with other config that the Electric client can use to stream the
    # shape directly from Electric.
    scope "/gatekeeper" do
      pipe_through :gatekeeper

      post "/:table", Gateway.Plug, client: &Authenticator.client/0
    end

    # The proxy endpoint at `GET /proxy/v1/shape` proxies the request to the
    # external Electric service.
    #
