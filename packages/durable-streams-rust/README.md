...
| `--repl-*`            | —         | (`replicated` mode) `--repl-id`, `--repl-peers 1@h:p,2@h:p,…`, `--repl-listen`, `--repl-ack-timeout-ms`, `--repl-snapshot-logs` — cluster membership and tuning; see [REPLICATION.md › Configuration](REPLICATION.md#configuration)                                                                                                                                                                                                                                                          |
