...
function shouldCollapseCommentMeta(
  ...
  const principal = principalKeyFromInput(row?.comment?.from_principal)
  if (!principal) return false
  return principal === principalKeyFromInput(nextRow?.comment?.from_principal)
}
  ...
  if (row.comment) {
    return {
      ...
      snapshot: {
        ...
        from: row.comment.from_principal,
