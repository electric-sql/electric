  ...
  describe "CallHomeReporter" do
    test "includes all relevant info in its reports" do
      ...
      Bypass.expect(bypass, "POST", "/checkpoint", fn conn ->
        ...
        static_info = ElectricTelemetry.Reporters.CallHomeReporter.static_info(telemetry_opts)
      ...
      ElectricTelemetry.Reporters.CallHomeReporter.child_spec(telemetry_opts,
        metrics: ElectricTelemetry.Reporters.CallHomeReporter.application_metrics(),
        first_report_in: {1, :millisecond}
      )
      |> start_supervised!()
