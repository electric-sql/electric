/**
 * Default state schemas for the standard Electric Agents entity event vocabulary.
 *
...
function toStateSchema(schema: unknown): Record<string, unknown> {
