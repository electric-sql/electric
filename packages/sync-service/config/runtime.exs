       ...
       %{
         config: %{
           ...
           metadata_map: %{
             ...
             total_retry_time_ms: "retry.total_time_ms",
             publication_name: "pg.publication_name",
             process_type: "process.type",
             inner_shape_handle: "shape.inner_handle",
             materializer_shape_handle: "shape.materializer_handle",
             ...
             number_to_expire: "shapes.number_to_expire",
             max_shapes: "shapes.max",
             total_shapes: "shapes.total",
             data_points: "telemetry.data_points",
             probe: "telemetry.probe",
             unexpected_msg: "unexpected_msg",
             step: "step",
             connection_pid: "connection.pid",
             materializer_pid: "materializer.pid",
             monitored_pid: "monitored.pid",
             process_spawn_opts: "process.spawn_opts",
             unknown_flags: "feature_flags.unknown",
             known_flags: "feature_flags.known",
             path_count: "storage.path_count",
             gc_info: "gc.info",
             locations: "schedule.locations",
             port: "port",
             xmin: "pg.xmin",
             xmax: "pg.xmax",
             xip_list: "pg.xip_list",
             since_offset: "shape.since_offset",
             extra_refs: "shape.extra_refs",
             child_module: "supervisor.child_module",
             shape_handles: "shape.handles",
             move_in_count: "shape.move_in_count",
             move_out_count: "shape.move_out_count",
             dep_handle: "shape.dep_handle",
             key_count: "shape.key_count",
             client_count: "shape.client_count",
             from: "shape.from",
             ...
             new_pg_id: "pg.new_id",
             old_pg_id: "pg.old_id",
             file_path: "persistent_kv.file_path"
           }
         }
       }}
    ]
