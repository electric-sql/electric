defmodule Electric.Shapes.ConsumerTest do
  ...
  defmodule CrashingStorage do
    ...
    def for_shape(shape_id, _tenant_id, opts) do
    ...
    test "crashing consumer resumes at a consistent point", ctx do
      ...
      replication_opts = [
        ...
        transaction_received: {
          ShapeLogCollector,
          :store_transaction,
          [ShapeLogCollector.name(ctx.electric_instance_id, ctx.tenant_id)]
        },
        relation_received: {
          ShapeLogCollector,
          :handle_relation_msg,
        ...
        Electric.Shapes.Supervisor.start_link(
          ...
          consumer_supervisor:
            {Electric.Shapes.ConsumerSupervisor,
             electric_instance_id: ctx.electric_instance_id, tenant_id: ctx.tenant_id}
        )
