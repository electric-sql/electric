defmodule Electric.Shapes.ConsumerTest do
  ...
  describe "event handling" do
    ...
    setup(ctx) do
      ...
      patch_shape_status(
        consume_shape_storage_state: fn _, _shape_handle -> nil end,
        ...
        set_shape_storage_state: fn _, _, _ -> :ok end
      )
    ...
    test "handles truncate without appending to log", ctx do
      ...
      expect_shape_status(remove_shape: fn _, @shape_handle1 -> :ok end)
    ...
    test "cleans shapes affected by a relation rename", ctx do
      ...
      expect_shape_status(
        remove_shape: fn _, @shape_handle1 -> :ok end,
        set_shape_storage_state: {
          fn
            _, @shape_handle1, _ -> :ok
            _, @shape_handle2, _ -> :ok
          end,
          force: true, exactly: 2
        }
      )
