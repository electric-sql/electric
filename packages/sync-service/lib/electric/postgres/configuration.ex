defmodule Electric.Postgres.Configuration do
  ...
  def check_publication_for_missing_relations(conn, publication_name, relations_with_oid) do
    relations = Enum.map(relations_with_oid, fn {_oid, {schema, table}} -> {schema, table} end)
