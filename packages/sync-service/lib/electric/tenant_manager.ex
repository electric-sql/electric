...
# TODO: TenantManager is a GenServer that manages tenants.
#       But creation should be done by the TenantSupervisor
#       which is a dynamic supervisor that manages the tenant processes
#       which is the one creating them through a static supervisor
