defmodule Electric.ShapeCache.PureFileStorage do
  ...
  def splice_move_in_snapshot!(name, writer_state(opts: opts, writer_acc: acc) = state) do
    starting_offset = WriteLoop.last_seen_offset(acc) |> dbg

    dbg(shape_snapshot_path(opts, name))
