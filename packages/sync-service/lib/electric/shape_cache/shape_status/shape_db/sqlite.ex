defmodule Electric.ShapeCache.ShapeStatus.ShapeDb.Sqlite do
  @moduledoc """
  ...
  alias Electric.ShapeCache.ShapeStatus.ShapeDb.Sqlite.WriteBuffer
  ...
  defp raise_on_error!({:error, reason}, action) do
    raise Electric.ShapeCache.ShapeStatus.ShapeDb.Sqlite.Error, error: reason, action: action
  end
end
