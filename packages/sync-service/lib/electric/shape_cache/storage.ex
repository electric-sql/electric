defmodule Electric.ShapeCache.Storage do
  ...
  with stiching being done via a separate call `splice_move_in_snapshot!`.
  """
  ...
  """
  @callback splice_move_in_snapshot!(name :: String.t(), writer_state()) ::
  ...
  @impl __MODULE__
  def splice_move_in_snapshot!(name, {mod, writer_state}) do
    {inserted_range, new_writer_state} = mod.splice_move_in_snapshot!(name, writer_state)
